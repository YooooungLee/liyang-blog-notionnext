...
export function GlobalContextProvider(props) {
  ...
  // 登录验证相关
  // Clerk only works with a real publishable key. Treat placeholder values such
  // as "undefined" (often introduced by deployment UIs) as disabled so a normal
  // public blog never attempts to read an absent Clerk context.
